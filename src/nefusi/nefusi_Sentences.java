...
public static class nefu extends AbstractProblem {
		...
		static List<Observation> testingData;
		...
		public nefu() {
			...
			//trainingData = generate("datasets/lawsentence200.nn");
			//testingData = generate("datasets/lawsentence200.nn");
			
			List<Observation> data = testingData = generate("datasets/lawsentence200.nn");
	...
	public static void main(String[] args) {
		...
		System.out.format("Training		Cosine		Test \n");
		
		for (Solution solution : result) {
			System.out.format("%.4f		%.4f		%.4f \n",
					-1 * solution.getObjective(0),
					1 * solution.getObjective(2),
